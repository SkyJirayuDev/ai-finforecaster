...
import { FaUser, FaCog, FaUpload, FaChartLine, FaDownload, FaRobot, FaArrowUp, FaBell, FaSearch, FaFileAlt, FaShieldAlt, FaBars, FaTimes } from "react-icons/fa";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex flex-col">
      ...
      <nav className="flex items-center justify-between p-4 lg:px-6 relative z-50">
        <div className="flex items-center gap-3 lg:gap-4">
          ...
          <div>
            <h1 className="text-lg lg:text-2xl font-bold text-white">FinanceForecaster</h1>
            <p className="text-blue-200 text-xs lg:text-sm hidden sm:block">Professional Analytics Platform</p>
          </div>
        </div>
      ...
      <div className="flex-1 flex relative">
          ...
          <div className="bg-white/95 backdrop-blur-lg rounded-2xl p-4 lg:p-6 shadow-xl border border-white/20">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs lg:text-sm text-gray-600">Data Encryption</span>
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs lg:text-sm text-gray-600">Compliance Check</span>
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs lg:text-sm text-gray-600">Audit Trail</span>
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
              </div>
            </div>
          </div>
        ...
        <ForecastChart forecastResult={forecastResult} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
            {/* Key Metrics */}
            <div className="bg-white/95 backdrop-blur-lg rounded-2xl p-4 lg:p-6 shadow-xl border border-white/20">
              <h3 className="text-base lg:text-lg font-semibold text-gray-800 mb-4">Key Metrics</h3>
              <div className="space-y-3 lg:space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600 text-xs lg:text-sm">Forecast Accuracy</span>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs lg:text-sm font-semibold text-gray-800">94.2%</span>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600 text-xs lg:text-sm">Risk Assessment</span>
                  <span className="text-xs lg:text-sm font-semibold text-amber-600">Moderate</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600 text-xs lg:text-sm">Confidence Level</span>
                  <span className="text-xs lg:text-sm font-semibold text-blue-600">87.5%</span>
                </div>
                <div className="flex justify-between items-center">
            ...
            <div className="bg-white/95 backdrop-blur-lg rounded-2xl p-4 lg:p-6 shadow-xl border border-white/20">
              ...
              <div className="space-y-3 text-xs lg:text-sm">
                <div className="p-2 lg:p-3 bg-blue-50 rounded-lg border-l-4 border-blue-400">
                  <p className="text-gray-700 font-medium">Portfolio Optimization</p>
                  <p className="text-gray-600 text-xs mt-1">Consider rebalancing allocation to emerging markets (+8% projected growth)</p>
                </div>
                <div className="p-2 lg:p-3 bg-amber-50 rounded-lg border-l-4 border-amber-400">
                  ...
                  <p className="text-gray-600 text-xs mt-1">Monitor sector concentration in technology assets (currently 34%)</p>
                </div>
              </div>
            </div>
            ...
            {/* Export & Reports */}
            <div className="bg-white/95 backdrop-blur-lg rounded-2xl p-4 lg:p-6 shadow-xl border border-white/20">
              <h3 className="text-base lg:text-lg font-semibold text-gray-800 mb-4">Reports & Export</h3>
              <div className="space-y-3">
                <button className="w-full flex items-center justify-between p-2 lg:p-3 bg-gray-50 hover:bg-gray-100 rounded-lg transition text-left">
                  <div>
                    <p className="text-xs lg:text-sm font-medium text-gray-800">Comprehensive Report</p>
                    <p className="text-xs text-gray-500">Full analysis with recommendations</p>
                  </div>
                  <FaDownload className="text-gray-400 text-sm" />
                </button>
                <button className="w-full flex items-center justify-between p-2 lg:p-3 bg-gray-50 hover:bg-gray-100 rounded-lg transition text-left">
                  <div>
                    <p className="text-xs lg:text-sm font-medium text-gray-800">Data Export</p>
                    <p className="text-xs text-gray-500">CSV, Excel, PDF formats</p>
                  </div>
                  <FaDownload className="text-gray-400 text-sm" />
                </button>
                <button className="w-full flex items-center justify-between p-2 lg:p-3 bg-gradient-to-r from-blue-50 to-cyan-50 hover:from-blue-100 hover:to-cyan-100 rounded-lg transition text-left border border-blue-200">
                  <div>
                    <p className="text-xs lg:text-sm font-medium text-blue-800">Executive Summary</p>
                    <p className="text-xs text-blue-600">Key insights for stakeholders</p>
                  </div>
